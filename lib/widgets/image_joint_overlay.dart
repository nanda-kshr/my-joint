                      ...
                      builder: (context, _) {
                        return GestureDetector(
                          ...
                          onTapDown: (TapDownDetails details) {
                            // Get the tap position relative to the SizedBox (container)
                            ...
                            for (final joint in widget.joints) {
                              final Offset jointPixelPosition = Offset(
                                joint.position.dx * containerWidth,
                                joint.position.dy * containerHeight,
                              );
                              final double distance = (jointPixelPosition - localPosition).distance;
                              final double threshold = joint.isFingerOrToe ? 20.0 : 32.0;
                          ...
                          child: CustomPaint(
                            painter: SimplifiedMannequinPainter(
                              ...
                              selectedJoints: widget.selectedJoints,
                              drawJointsOnly: true,
                            ),
                            size: Size.infinite,
                          ),
